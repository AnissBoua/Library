 ...
 */
final class Version20221205211643 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre_panier (livre_id INT NOT NULL, panier_id INT NOT NULL, INDEX IDX_808ECA07F77D927C (panier_id), INDEX IDX_808ECA0737D925CB (livre_id), PRIMARY KEY(livre_id, panier_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
