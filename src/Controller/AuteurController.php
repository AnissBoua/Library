...
class AuteurController extends AbstractController
{
    ...
    #[Route('admin/auteur', name: 'admin_app_auteur_index', methods: ['GET'])]
    public function adminIndex(AuteurRepository $auteurRepository): Response
    {
        return $this->render('auteur/index.html.twig', [
            'auteurs' => $auteurRepository->findAll(),
        ]);
    }
    #[Route('admin/auteur/new', name: 'app_auteur_new', methods: ['GET', 'POST'])]
    public function new(Request $request, AuteurRepository $auteurRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_app_auteur_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('admin/auteur/{id}/edit', name: 'app_auteur_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('admin/auteur/{id}', name: 'app_auteur_delete', methods: ['POST'])]
